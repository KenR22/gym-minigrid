...
class DynamicObstaclesEnv(MiniGridEnv):
    ...
    def _gen_grid(self, width, height):
        ...
        self.obstacles.append(Goal())
        self.place_obj(self.obstacles[-1],(width - 2, height - 2), max_tries=100)
